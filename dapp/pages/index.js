...
import DumbWojapes2 from "../contractABI/DumbWojapes2.json";
...
export default function Home() {
  ...
  const [holderSalePeriod, setHolderSalePeriod] = useState(false);
  ...
  useEffect(() => {
    setHolderSalePeriod(holderMintPhase);
    setWLSalePeriod(WLMintPhase);
  });
  ...
  const {
    ...
    isSuccess: wlSuccess,
    write: wlMint,
  } = useContractWrite(wlMintConfig);

  ////////Functions///////////

  const holdersMint = async () => {
    try {
      const nftsForOwner = await alchemy.nft.getNftsForOwner(
        address,
        "0x00B07317e8eE314F5Aca2ee3ABCD1967722a557c",
        true
      );
      const nftIds = await nftsForOwner.ownedNfts.map((nft) => nft.tokenId);

      setIDs(nftIds);

      const tx = await ownerMint();
  ...
  return (
    <div class="flex flex-col h-screen">
      <Head>
        <title>Wojapes 2</title>
        <meta
          content="Generated by @rainbow-me/create-rainbowkit"
          name="description"
        />
        <link href="https://pbs.twimg.com/profile_images/1556651355019919365/jGWkWdHo_400x400.jpg" rel="icon" />
      </Head>

      <header class="bg-white dark:bg-gray-900  w-full top-0 left-0 border-b border-gray-200 dark:border-gray-600">
        <div class=" flex flex-wrap items-center justify-between mx-auto p-4">
          <a
            href="https://twitter.com/secretlyaveryf1"
            class="flex items-center"
          >
            <img
              src="https://pbs.twimg.com/profile_images/1556651355019919365/jGWkWdHo_400x400.jpg"
              class="h-8 mr-3"
              alt="Flowbite Logo"
            />
          ...
          >
            <ul class="flex flex-col p-4 md:p-0 mt-4 font-medium border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
              <li>
                <a
                  href="https://opensea.io/collection/dumbwojapes"
              ...
              <li>
                <a
                  href="https://sepolia.etherscan.io/address/0x4e86cc09576906f0bb9f386868ef815b5f3616e1#code"
              ...
              <li>
                <a
                  href="https://twitter.com/dumbwojapes"
                  class="block py-2 pl-3 pr-4 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0 md:dark:hover:text-blue-500 dark:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700"
                >
                  Twitter
                </a>
              ...
              <li>
                <a
                  href="https://discord.gg/DDENzWTH"
                  class="block py-2 pl-3 pr-4 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0 md:dark:hover:text-blue-500 dark:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700"
                >
                  Discord
                </a>
      ...
      <main class=" flex items-center justify-center h-screen w-screen bg-[url('https://pbs.twimg.com/profile_images/1556651355019919365/jGWkWdHo_400x400.jpg')] bg-repeat-space">
        <div class="bg-white">
          ...
          {!wlSalePeriod && !holderSalePeriod && (
            <div class="flex items-center justify-center">
              <button className="bg-blue-500 hover:bg-blue-400 text-white font-bold py-2 px-4 border-b-4 border-blue-700 hover:border-blue-500 rounded">
                Cunnect your wallet dummy
              </button>
            </div>
          )}
          ...
          {wlSalePeriod && (
            <div>
              <button onClick={() => whitelistMint?.()} class="bg-cyan-500">
                Mint WL NFTs
              </button>
            </div>
          )}
      ...
      <footer class="mt-auto bg-white rounded-lg shadow m-4 dark:bg-gray-800 ">
        ...
        <hr class="sm:mx-auto dark:border-gray-700 " />
